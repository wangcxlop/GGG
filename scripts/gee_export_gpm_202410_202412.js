...
// 作用：按项目现有的 GPM 长表格式，导出 2024 年 10、11、12 月的逐小时站点数据。
// 导出的 CSV 文件名：gpm_hubei_hourly_long_202410.csv（以及 202411、202412）。

var START = ee.Date('2024-10-01T00:00:00');
var END = ee.Date('2025-01-01T00:00:00'); // 右开区间
...
exportMonth(2024, 10, 2024, 11);
exportMonth(2024, 11, 2024, 12);
exportMonth(2024, 12, 2025, 1);
