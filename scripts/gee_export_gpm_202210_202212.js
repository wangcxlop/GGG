...
// 作用：按项目现有的 GPM 长表格式，导出 2022 年 10、11、12 月的逐小时站点数据。
// 导出的 CSV 文件名：gpm_hubei_hourly_long_202210.csv（以及 202211、202212）。

var START = ee.Date('2022-10-01T00:00:00');
var END = ee.Date('2023-01-01T00:00:00'); // 右开区间
...
exportMonth(2022, 10, 2022, 11);
exportMonth(2022, 11, 2022, 12);
exportMonth(2022, 12, 2023, 1);
