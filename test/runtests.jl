...
include("test-heavy-rain-events.jl")
include("test-landform-classification.jl")
include("test-satellite-temporal-evaluation.jl")
include("test-no-rain-evaluation.jl")
include("test-grid-support-diagnostics.jl")
